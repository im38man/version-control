...
<head>
    ...
    <title>Login - Nusantara Beans</title>
...
<?php include 'includes/navbar.php'; ?>
    ...
    <div class="user-page-container">
        <h2 class="page-header-title">Masuk ke <span>Akun Anda</span></h2>

        <div class="profile-card">
            <h3 class="profile-card-title"><i class="fas fa-sign-in-alt"></i> Login</h3>
            <?php if ($error): ?>
            ...
            <p style="margin-top:15px;">Belum punya akun? <a href="register.php" style="color:var(--color-gold); font-weight:600;">Daftar di sini</a></p>
        </div>
    </div>

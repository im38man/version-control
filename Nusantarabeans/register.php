...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($full_name === '' || $email === '' || $password === '') {
        ...
        if ($stmt->fetch()) {
            ...
            $stmt->execute([$full_name, $email, $phone, $hash, 'user']);
...
<head>
    ...
    <title>Daftar Akun - Nusantara Beans</title>
...
<?php include 'includes/navbar.php'; ?>
    ...
    <div class="user-page-container">
        <h2 class="page-header-title">Daftar <span>Akun Baru</span></h2>

        <div class="profile-card">
            <h3 class="profile-card-title"><i class="fas fa-user-plus"></i> Formulir Pendaftaran</h3>
            <?php if ($error): ?>
            ...
            <p style="margin-top:15px;">Sudah punya akun? <a href="login.php" style="color:var(--color-gold); font-weight:600;">Login di sini</a></p>
            <?php endif; ?>
        </div>
    </div>

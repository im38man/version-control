...
<head>
    ...
    <title>Keagungan Budaya Klasik Yogyakarta - Zenith Tour & Travel</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; }
        ...
        .package-hero { position: relative; height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff; background-image: url('https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?auto=format&fit=crop&q=80&w=1200'); background-size: cover; background-position: center; }
...
<body>
    ...
    <header class="package-hero">
        <div class="hero-content">
            <span class="hero-tag">Warisan Budaya Dunia</span>
            <h1>Keagungan Budaya Klasik Yogyakarta</h1>
            <p><i class="fa-solid fa-location-dot" style="color: #c5a880; margin-right: 8px;"></i> Malioboro - Candi Prambanan, Yogyakarta, Indonesia</p>
        </div>
    </header>
    ...
    <div style="max-width:1000px;margin:20px auto 0;padding:0 20px;text-align:right;">
        <?php render_favorite_button('yogyakarta', 'Keagungan Budaya Klasik Yogyakarta'); ?>
    </div>
    ...
    <div class="detail-wrapper">
        <div class="detail-content">
            <section id="ikhtisar">
                ...
                <p>Saksikan keagungan warisan sejarah dan kehangatan budaya Jawa dalam perjalanan istimewa ke Yogyakarta. Menjelajahi kemegahan candi berarsitektur agung, keraton bersejarah, hingga keindahan matahari terbit di lereng Gunung Merapi.</p>
                
                <h4 style="font-size: 16px; color: #1a2f27; margin: 25px 0 15px 0; font-family: 'Playfair Display', serif;">Sorotan Utama Wisata:</h4>
                <ul class="highlight-list">
                    <li>Menjelajahi kemegahan Candi Prambanan dan Candi Borobudur yang megah.</li><li>Menyusuri pusat kebudayaan Keraton Ngayogyakarta Hadiningrat.</li><li>Berbelanja batik klasik dan suvenir khas di sepanjang Jalan Malioboro.</li><li>Menikmati petualangan seru Jeep Lava Tour menyusuri sisa erupsi Merapi.</li>
                </ul>
            </section>
            ...
            <section id="itinerary">
                ...
                <div class="itinerary-timeline">
                    ...
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 1: Jejak Sejarah Keraton & Malioboro</div>
                        <div class="itinerary-desc">Penjemputan di Stasiun/Bandara Yogyakarta, mengunjungi Keraton Yogyakarta dan Taman Sari. Malam hari menikmati suasana malam di kawasan legendaris Jalan Malioboro.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 2: Kemegahan Candi & Merapi Lava Tour</div>
                        <div class="itinerary-desc">Pagi hari mengunjungi Candi Prambanan mahakarya hindu. Siang hari mengikuti serunya Merapi Lava Tour menggunakan jeep terbuka berlatar pemandangan gunung berapi.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 3: Sentra Batik & Kepulangan</div>
                        <div class="itinerary-desc">Berbelanja oleh-oleh bakpia pathok dan kain batik tulis asli Jogja sebelum diantar kembali ke stasiun atau bandara untuk perjalanan pulang.</div>
                    </div>
                </div>
            </section>
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                    <div>
                        ...
                        <ul class="inclusion-list inc-yes">
                            <li>Akomodasi Hotel Bintang 4 di kawasan pusat kota Yogyakarta (2 Malam)</li><li>Transportasi private nyaman ber-AC selama tour</li><li>Tiket masuk candi (Prambanan) & Keraton Yogyakarta</li><li>Sewa Jeep Merapi Lava Tour berpengalaman</li><li>Makan gourmet sesuai program termasuk kuliner gudeg khas Jogja</li>
                        </ul>
                    </div>
                    <div style="margin-top: 10px;">
                        <h4 style="font-size: 15px; color: #1a2f27; margin-bottom: 15px;">Tidak Termasuk (Exclusions):</h4>
                        <ul class="inclusion-list inc-no">
                            <li>Tiket kereta/pesawat menuju Yogyakarta</li><li>Pengeluaran pribadi dan tips</li><li>Tiket tambahan Candi Borobudur (opsional)</li>
                        </ul>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div class="sidebar-booking" id="booking">
                <div class="price-tag">Rp 2.950.000</div>
                ...
                <form class="booking-form-sidebar" onsubmit="prosesBooking(event)">
                    ...
                    <input type="hidden" id="paket" value="Keagungan Budaya Klasik Yogyakarta">

...
<head>
    ...
    <title>Eksotika Metropolitan Jakarta - Zenith Tour & Travel</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; }
        ...
        .package-hero { position: relative; height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff; background-image: url('https://images.unsplash.com/photo-1555899434-9461158aa79c?auto=format&fit=crop&q=80&w=1200'); background-size: cover; background-position: center; }
...
<body>
    ...
    <header class="package-hero">
        <div class="hero-content">
            <span class="hero-tag">Metropolis Modern</span>
            <h1>Eksotika Metropolitan Jakarta</h1>
            <p><i class="fa-solid fa-location-dot" style="color: #c5a880; margin-right: 8px;"></i> Monas - Kota Tua, Jakarta, Indonesia</p>
        </div>
    </header>
    ...
    <div style="max-width:1000px;margin:20px auto 0;padding:0 20px;text-align:right;">
        <?php render_favorite_button('jakarta', 'Eksotika Metropolitan Jakarta'); ?>
    </div>
    ...
    <div class="detail-wrapper">
        <div class="detail-content">
            <section id="ikhtisar">
                ...
                <p>Jelajahi denyut nadi megah ibu kota negara dalam balutan kemewahan modern dan sejarah kolonial tempo dulu. Dari landmark ikonik Monas, pelayaran marina Ancol, hingga pusat perbelanjaan dan kuliner malam kelas dunia.</p>
                
                <h4 style="font-size: 16px; color: #1a2f27; margin: 25px 0 15px 0; font-family: 'Playfair Display', serif;">Sorotan Utama Wisata:</h4>
                <ul class="highlight-list">
                    <li>Menyaksikan panorama kota dari puncak monumen ikonik Monas.</li><li>Menelusuri jejak sejarah kolonial Belanda di kawasan Kota Tua Jakarta.</li><li>Menikmati senja romantis di pesisir pantai Marina Ancol.</li><li>Berbelanja di pusat perbelanjaan mewah kelas atas ibukota.</li>
                </ul>
            </section>
            ...
            <section id="itinerary">
                ...
                <div class="itinerary-timeline">
                    ...
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 1: Landmark Monas & Sejarah Kota Tua</div>
                        <div class="itinerary-desc">Penjemputan di Bandara Soekarno-Hatta, langsung menuju Monumen Nasional (Monas). Siang hari menjelajahi museum sejarah dan cafe vintage di kawasan Kota Tua Batavia.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 2: Rekreasi Modern & Sunset Ancol</div>
                        <div class="itinerary-desc">Mengunjungi Dunia Fantasi (Dufan) atau Sea World Ancol. Sore hari menikmati keindahan matahari terbenam di pesisir pantai Marina Ancol dengan makan malam seafood tepi laut.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 3: Wisata Belanja & Kepulangan</div>
                        <div class="itinerary-desc">Berbelanja buah tangan khas Betawi dan menikmati suasana pusat kota sebelum diantar kembali menuju bandara untuk kepulangan.</div>
                    </div>
                </div>
            </section>
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                    <div>
                        ...
                        <ul class="inclusion-list inc-yes">
                            <li>Akomodasi Hotel Bintang 4 mewah di pusat kota Jakarta (2 Malam)</li><li>Transportasi private eksklusif ber-AC</li><li>Tiket masuk objek wisata (Monas, Kota Tua, Ancol)</li><li>Makan gourmet kelas atas sesuai program termasuk seafood Jimbaran style Ancol</li><li>Pemandu wisata profesional</li>
                        </ul>
                    </div>
                    <div style="margin-top: 10px;">
                        <h4 style="font-size: 15px; color: #1a2f27; margin-bottom: 15px;">Tidak Termasuk (Exclusions):</h4>
                        <ul class="inclusion-list inc-no">
                            <li>Tiket pesawat menuju Jakarta</li><li>Pengeluaran belanja pribadi dan tips</li><li>Wahana permainan tambahan di luar program</li>
                        </ul>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div class="sidebar-booking" id="booking">
                <div class="price-tag">Rp 2.900.000</div>
                ...
                <form class="booking-form-sidebar" onsubmit="prosesBooking(event)">
                    ...
                    <input type="hidden" id="paket" value="Eksotika Metropolitan Jakarta">

...
<head>
    ...
    <title>Pesona Tropis Nusa Penida Bali - Zenith Tour & Travel</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; }
        ...
        /* Navbar Konsisten dengan Index & Search - Responsive Fix */
        ...
        .package-hero { position: relative; height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff; background-image: url('https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=1200'); background-size: cover; background-position: center; }
...
<body>
    ...
    <header class="package-hero">
        <div class="hero-content">
            <span class="hero-tag">Pantai Eksotis</span>
            <h1>Pesona Tropis Nusa Penida Bali</h1>
            <p><i class="fa-solid fa-location-dot" style="color: #c5a880; margin-right: 8px;"></i> Nusa Penida - Ubud, Bali, Indonesia</p>
        </div>
    </header>
    ...
    <div style="max-width:1000px;margin:20px auto 0;padding:0 20px;text-align:right;">
        <?php render_favorite_button('bali', 'Pesona Tropis Nusa Penida Bali'); ?>
    </div>
    ...
    <div class="detail-wrapper">
        <div class="detail-content">
            <section id="ikhtisar">
                ...
                <p>Rasakan magisnya pulau dewata dalam kemasan yang eksklusif. Paket ini membawa Anda menyeberangi laut menuju pulau eksotis Nusa Penida yang terkenal dengan tebing dramatis dan air laut kristal bergradasi, dilanjutkan dengan ketenangan budaya spiritual di tengah hutan tropis Ubud.</p>
                
                <h4 style="font-size: 16px; color: #1a2f27; margin: 25px 0 15px 0; font-family: 'Playfair Display', serif;">Sorotan Utama Wisata:</h4>
                <ul class="highlight-list">
                    <li>Berfoto di tebing ikonik Kelingking Beach yang menyerupai T-Rex.</li>
                    <li>Berenang dan bersantai di kolam alami Angel's Billabong & Broken Beach.</li>
                    <li>Menikmati ketenangan staycation di resort mewah bernuansa alam Ubud.</li>
                    <li>Menyaksikan pertunjukan tarian tradisional kecak saat matahari terbenam.</li>
                </ul>
            </section>
            ...
            <section id="itinerary">
                ...
                <div class="itinerary-timeline">
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 1: Penyeberangan Eksotis Nusa Penida</div>
                        <div class="itinerary-desc">Pagi hari dijemput di Bandara Ngurah Rai, langsung menuju Sanur untuk menaiki Fast Boat Eksekutif menuju Nusa Penida. Mengunjungi Kelingking Beach, Broken Beach, dan Angel's Billabong. Sore hari kembali ke pulau utama Bali.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 2: Ketenangan Ubud & Sunset Kecak</div>
                        <div class="itinerary-desc">Menuju Ubud menikmati pemandangan sawah terasiring Tegalalang. Siang hari mengunjungi hutan monyet suci (Sacred Monkey Forest). Sore hari menyaksikan tari Kecak magis berlatar samudra luas.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 3: Relaksasi Pantai & Kepulangan</div>
                        <div class="itinerary-desc">Menikmati spa khas Bali gratis untuk relaksasi tubuh sebelum kepulangan. Berbelanja kerajinan seni kelas premium di Krisna/Agung Bali sebelum diantar kembali ke Bandara.</div>
                    </div>
                </div>
            </section>
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                    <div>
                        ...
                        <ul class="inclusion-list inc-yes">
                            <li>Akomodasi Boutique Resort/Vila Private Premium 2 malam</li>
                            <li>Tiket Fast Boat pulang pergi Sanur - Nusa Penida (VIP)</li>
                            <li>Transportasi private mobil ber-AC selama wisata berlangsung</li>
                            <li>1x Sesi Premium Balinese Spa Massage</li>
                            <li>Makan gourmet sesuai program termasuk seafood Jimbaran</li>
                        </ul>
                    </div>
                    <div style="margin-top: 10px;">
                        <h4 style="font-size: 15px; color: #1a2f27; margin-bottom: 15px;">Tidak Termasuk (Exclusions):</h4>
                        <ul class="inclusion-list inc-no">
                            <li>Tiket pesawat ke Bali</li>
                            <li>Retribusi daerah wisata asing (jika ada WNA)</li>
                            <li>Pengeluaran belanja pribadi dan tips</li>
                        </ul>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div class="sidebar-booking" id="booking">
                <div class="price-tag">Rp 3.800.000</div>
                ...
                <form class="booking-form-sidebar" onsubmit="prosesBooking(event)">
                    ...
                    <input type="hidden" id="paket" value="Pesona Tropis Nusa Penida Bali">
    ...
    <div class="package-gallery-section">
        ...
        <div class="gallery-grid" id="galleryGrid">
            <div class="gallery-item" style="background-image: url('img/bali-01.webp');" onclick="openZoomModal('img/bali-01.webp')"></div>
            <div class="gallery-item" style="background-image: url('img/bali-02.webp');" onclick="openZoomModal('img/bali-02.webp')"></div>
            <div class="gallery-item" style="background-image: url('img/bali-03.webp');" onclick="openZoomModal('img/bali-03.webp')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1570789210967-2cac24afeb00?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1570789210967-2cac24afeb00?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1558005530-d3c16f2c366e?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1558005530-d3c16f2c366e?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1559628376-f365d1a76c59?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1559628376-f365d1a76c59?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1512100356356-de1b84283e18?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1512100356356-de1b84283e18?auto=format&fit=crop&q=80&w=800')"></div>
            <div class="gallery-item" style="background-image: url('https://images.unsplash.com/photo-1578593147286-631e054668c2?auto=format&fit=crop&q=80&w=800');" onclick="openZoomModal('https://images.unsplash.com/photo-1578593147286-631e054668c2?auto=format&fit=crop&q=80&w=800')"></div>
        </div>

        <!-- Tombol Navigasi Kanan Kiri di Bawah Galeri -->
    ...
    <div class="marquee-section">
        ...
        <div class="marquee-container">
            <div class="marquee-track">
                <!-- Set 1 -->
                <a href="semua-destinasi.php" class="poster-card" style="background-image: url('img/kawah-putih-02.webp');"><div class="poster-name">Kawah Putih Bandung</div></a>
                <a href="semua-destinasi.php" class="poster-card" style="background-image: url('img/yogyakarta-02.webp');"><div class="poster-name">Klasik Yogyakarta</div></a>
                <a href="paket-bali.php" class="poster-card" style="background-image: url('img/bali-02.webp');"><div class="poster-name">Eksotika Bali</div></a>
                <a href="semua-destinasi.php" class="poster-card" style="background-image: url('img/malang-02.webp');"><div class="poster-name">Pesona Malang & Bromo</div></a>
                <a href="semua-destinasi.php" class="poster-card" style="background-image: url('img/jakarta-02.webp');"><div class="poster-name">Metropolitan Jakarta</div></a>
    ...
    <script>
        ...
        // GALLERY RESPONSIVE PAGINATION LOGIC

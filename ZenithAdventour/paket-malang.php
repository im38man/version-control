...
<head>
    ...
    <title>Pesona Alam Malang & Sunrise Bromo - Zenith Tour & Travel</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; scroll-behavior: smooth; }
        ...
        .package-hero { position: relative; height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff; background-image: url('https://images.unsplash.com/photo-1588668214407-6ea9a6d8c272?auto=format&fit=crop&q=80&w=1200'); background-size: cover; background-position: center; }
...
<body>
    ...
    <header class="package-hero">
        <div class="hero-content">
            <span class="hero-tag">Petualangan Pegunungan</span>
            <h1>Pesona Alam Malang & Sunrise Bromo</h1>
            <p><i class="fa-solid fa-location-dot" style="color: #c5a880; margin-right: 8px;"></i> Gunung Bromo - Kota Batu, Malang, Indonesia</p>
        </div>
    </header>
    ...
    <div style="max-width:1000px;margin:20px auto 0;padding:0 20px;text-align:right;">
        <?php render_favorite_button('malang', 'Pesona Alam Malang & Sunrise Bromo'); ?>
    </div>
    ...
    <div class="detail-wrapper">
        <div class="detail-content">
            <section id="ikhtisar">
                ...
                <p>Rasakan sensasi petualangan menakjubkan di Jawa Timur. Menyaksikan matahari terbit spektakuler dari puncak Bromo, lautan pasir berbisik, serta menikmati kesejukan kota wisata Batu yang dipenuhi taman bunga dan hiburan modern.</p>
                
                <h4 style="font-size: 16px; color: #1a2f27; margin: 25px 0 15px 0; font-family: 'Playfair Display', serif;">Sorotan Utama Wisata:</h4>
                <ul class="highlight-list">
                    <li>Menyaksikan Golden Sunrise ikonik dari puncak penanjakan Gunung Bromo.</li><li>Menjelajahi lautan pasir luas dan mendaki kawah aktif Bromo.</li><li>Mengunjungi kebun buah apel segar langsung dari pohonnya di Kota Batu.</li><li>Menikmati wahana rekreasi keluarga kelas dunia di Jatim Park Group.</li>
                </ul>
            </section>
            ...
            <section id="itinerary">
                ...
                <div class="itinerary-timeline">
                    ...
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 1: Penjemputan & Wisata Batu</div>
                        <div class="itinerary-desc">Penjemputan di Malang/Surabaya, langsung menuju Kota Batu mengunjungi Selecta dan Museum Angkut yang megah serta bersantai di udara sejuk pegunungan.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 2: Sunrise Bromo & Lautan Pasir</div>
                        <div class="itinerary-desc">Dini hari pukul 02.00 berangkat menggunakan Hardtop 4x4 menuju Penanjakan Bromo untuk menikmati sunrise, dilanjutkan menyeberangi lautan pasir dan menaiki tangga kawah Bromo.</div>
                    </div>
                    <div class="itinerary-step">
                        <div class="itinerary-day">Hari 3: Oleh-oleh Khas Malang & Kepulangan</div>
                        <div class="itinerary-desc">Berbelanja keripik tempe sanan dan bakso malang legendaris sebelum diantar kembali menuju stasiun atau bandara.</div>
                    </div>
                </div>
            </section>
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 20px;">
                    <div>
                        ...
                        <ul class="inclusion-list inc-yes">
                            <li>Akomodasi Hotel Bintang 4 di Kota Batu/Malang (2 Malam)</li><li>Sewa Jeep Hardtop 4x4 khusus penjemputan Bromo sunrise</li><li>Transportasi private ber-AC selama tour berlangsung</li><li>Tiket masuk objek wisata (Bromo, Selecta, Museum Angkut)</li><li>Makan gourmet sesuai program perjalanan</li>
                        </ul>
                    </div>
                    <div style="margin-top: 10px;">
                        <h4 style="font-size: 15px; color: #1a2f27; margin-bottom: 15px;">Tidak Termasuk (Exclusions):</h4>
                        <ul class="inclusion-list inc-no">
                            <li>Tiket transportasi utama ke Malang/Surabaya</li><li>Sewa kuda di kawasan Bromo (opsional)</li><li>Pengeluaran pribadi</li>
                        </ul>
                    </div>
                </div>
            </section>
        ...
        <div>
            <div class="sidebar-booking" id="booking">
                <div class="price-tag">Rp 3.200.000</div>
                ...
                <div class="sidebar-info">
                    ...
                    <span>Private Car & Jeep 4x4</span>
                </div>
                <div class="sidebar-info" style="border-bottom: none;">
                    ...
                    <span>Boutique Hotel & Resort</span>
                </div>
                ...
                <form class="booking-form-sidebar" onsubmit="prosesBooking(event)">
                    ...
                    <input type="hidden" id="paket" value="Pesona Alam Malang & Sunrise Bromo">
